...
public class SaturationBar extends View
{
	...
	/**
	 * Interface and listener so that changes in SaturationBar are sent to the host
	 * activity/fragment
	 */
	...
	protected void onSizeChanged(int w, int h, int oldw, int oldh)
	{
		...
		if (!isInEditMode())
		{
			...
			{ Color.WHITE, Color.HSVToColor(0xFF, mHSVColor) }, null, Shader.TileMode.CLAMP);
		} else
		{
			shader = new LinearGradient(mBarPointerHaloRadius, 0, x1, y1, new int[]
	...
	private void calculateColor(int coord)
	{
		...
		{ mHSVColor[0], ((mPosToSatFactor * coord)), 1f });
	}
