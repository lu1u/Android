...
public class OpacityBar extends View
{
	...
	/**
	 * Interface and listener so that changes in OpacityBar are sent to the host activity/fragment
	 */
	...
	public void setColor(int color)
	{
		...
		shader = new LinearGradient(mBarPointerHaloRadius, 0, x1, y1, new int[]
		{ Color.HSVToColor(0x00, mHSVColor), color }, null, Shader.TileMode.CLAMP);
		mBarPaint.setShader(shader);
